...
async function main() {
  ...
  await Promise.all([
    downloadFile(
      'https://raw.githubusercontent.com/vonage-community/tutorial-interactive_tutorials/refs/heads/ai/toolbar-app/vonage-toolbar/integration.ts',
      'integration.ts'
    ),
    downloadFile(
      'https://raw.githubusercontent.com/vonage-community/tutorial-interactive_tutorials/refs/heads/ai/toolbar-app/vonage-toolbar/app.ts',
      'app.ts'
    )
  ]);
