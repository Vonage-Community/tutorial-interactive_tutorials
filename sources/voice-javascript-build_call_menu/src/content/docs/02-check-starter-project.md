...
> **Tip**: `project/package.json` defines a start script that uses `node --watch index.js`. The Codespace starts this script automatically, so the server reloads whenever you save a change.
